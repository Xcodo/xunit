...
namespace Xunit.Runner.v3
{
	...
	/// </summary>
	public abstract class TcpEngine : IAsyncDisposable
	{
		...
		/// <summary>
		/// Override this method to provide disconnection behavior. This is called in
		/// response to <see cref="DisposeAsync"/>.
		/// </summary>
		protected abstract ValueTask Disconnect();
